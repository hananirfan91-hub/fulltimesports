...
export default function TrustPages({ page, onNavigate }: TrustPageProps) {
  ...
  {/* Profile Image Card */}
  <div className="md:col-span-4 relative bg-[#01140f] p-4 rounded-xl border border-emerald-900 flex flex-col items-center justify-center text-center space-y-3 overflow-hidden">

    {/* Image */}
    <div className="relative w-28 h-28 rounded-full overflow-hidden border-2 border-emerald-900 shadow-md">
      <img
    ...
    {/* Name Below Image (optional but kept clean) */}
    <h4 className="text-xs font-bold text-white uppercase font-mono">
      Hanan Irfan
    </h4>

    <p className="text-[10px] text-[#22c55e] font-mono mt-0.5">
      HI Digital Group
    </p>
