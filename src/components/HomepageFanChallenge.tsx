        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <h2 className="font-display font-black text-2xl sm:text-3xl text-white uppercase tracking-tight leading-tight">
              {todayQuiz ? todayQuiz.title : "Daily Sports Knowledge Quiz"}
            </h2>

            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed max-w-xl">
              Test your expertise on international cricket, UEFA football, Formula 1 telemetry, and NBA analytics! Earn points to secure your place on the official Monthly Sports Fan Leaderboard!
            </p>
